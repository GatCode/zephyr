...
static K_SEM_DEFINE(sem_big_sync, 0, ISO_CHAN_COUNT);
static K_SEM_DEFINE(sem_big_sync_lost, 0, ISO_CHAN_COUNT);
...
static uint32_t seq_num = 0; // TODO: remove
static uint32_t prev_seq_num = 0; // TODO: remove
...
static struct bt_iso_big_sync_param big_sync_param = {
	...
	.bis_bitfield = (BIT_MASK(ISO_CHAN_COUNT) << 1),
	.mse = 31,
	.sync_timeout = ISO_SYNC_TIMEOUT,
};
